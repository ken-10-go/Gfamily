 ...
 *
 * 江戸期の元号も、戸籍をさかのぼると必ず出てくるので載せている。
 * ただし明治5年までは太陰太陽暦（旧暦）で、和暦の月日とグレゴリオ暦の月日は一致しない。
 * ここでの換算はあくまで「年の対応」までで、月日は入力されたものをそのまま扱う。
 * 正確な日付が要る場面では、人物の元号データ（birthEra / deathEra）を見ること。
 */
export const ERAS: EraDefinition[] = [
  { name: '天保', start: '1831-01-23' },
  { name: '弘化', start: '1845-01-09' },
  { name: '嘉永', start: '1848-04-01' },
  { name: '安政', start: '1855-01-15' },
  { name: '万延', start: '1860-04-08' },
  { name: '文久', start: '1861-03-29' },
  { name: '元治', start: '1864-03-27' },
  { name: '慶応', start: '1865-05-01' },
